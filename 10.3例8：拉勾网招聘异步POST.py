    ...
    for pn in range(1,page+1):
        ...
        try:
            ...
            for result in results:
                ...
                context.append([city,companyFullName,companyLabelList,education,positionName,salary])
                time.sleep(2)
...
if __name__ == '__main__':
    ...
    head=['city','companyFullName','companyLabelList','education','positionName','salary']
